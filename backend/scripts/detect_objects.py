...
def detect_objects_yolo(frames):
    ...
    try:
        ...
        for frame in frames:
            # Run detection with verbose=False to suppress debug output
        ...
        # Log error to stderr but don't print to stdout (which breaks JSON)
...
def main():
    ...
    try:
        ...
        # Return results as JSON - this should be the ONLY output to stdout
        result = {
            "objects": objects,
